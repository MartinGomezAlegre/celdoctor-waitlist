        ...
        >
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label={editing ? "Nueva contrasena" : "Contrasena inicial"}>
                    <Input name="access_password" type="password" value={values.access_password} onChange={onChange} placeholder={editing ? "Solo si queres resetearla" : "Definila con el responsable comercial"} />
                </Field>
            </div>
            <p className="mt-3 text-xs text-slate-500">
                El broker ingresa desde <span className="font-semibold text-slate-700">/comercial</span>. La contrasena inicial la define el responsable comercial y luego puede cambiarse si lo solicitan.
            </p>
        </Modal>
    )
}
...
export function DirectSellerModal({
    ...
    return (
        ...
        >
            ...
            <p className="mt-3 text-xs text-slate-500">
                El vendedor directo ingresa por <span className="font-semibold text-slate-700">/comercial</span>. La contrasena inicial la define el responsable comercial y luego puede cambiarse si lo solicitan.
            </p>
        </Modal>
    )
}
