export const adminEndpoints = {
    ...
    catalogoMedicamentos:    "/admin/catalogo/medicamentos",
    catalogoMedicamento: (id: number) => `/admin/catalogo/medicamentos/${id}`,
    catalogoFarmacias:       "/admin/catalogo/farmacias",
    catalogoFarmacia: (id: number) => `/admin/catalogo/farmacias/${id}`,
    planes:                  "/admin/planes",
