                ...
                <div className="max-w-5xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        >
                            ...
                            <a href="/#waitlist" className="w-full py-4 text-center border border-[#4C1D95]/20 text-[#4C1D95] rounded-xl font-bold hover:bg-[#4C1D95] hover:text-white hover:shadow-lg hover:shadow-[#4C1D95]/20 transition-all block">
                                Solicitar Alta
                            </a>
                        </motion.div>
                        ...
                        >
                            ...
                            <a href="/#waitlist" className="w-full py-4 text-center bg-white text-[#2E1065] rounded-xl font-bold hover:bg-slate-100 transition-all shadow-lg block">
                                Elegir Premium
                            </a>
                        </motion.div>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-br from-[#4C1D95] via-[#3b1675] to-[#2E1065] relative overflow-hidden">
                ...
                <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        <h2 className="text-3xl lg:text-4xl font-bold text-white mb-3 leading-tight">Asegurá tu lugar en el lanzamiento para Argentina, Uruguay y Paraguay</h2>
                        <p className="text-lg text-white/70 mb-8">Sé de los primeros en acceder a CelDoctor.</p>
                        {subscribed ? (
