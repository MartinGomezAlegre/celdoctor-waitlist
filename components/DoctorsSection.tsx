          ...
          <div className="order-1 lg:order-2 text-white space-y-8">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Digitaliza tu consultorio y sé parte de la <span className="text-transparent bg-clip-text bg-linear-to-r from-[#a78bfa] to-white">red médica del futuro.</span>
              </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <a
                href="#waitlist"
                className="inline-flex justify-center items-center px-8 py-4 bg-linear-to-r from-[#4C1D95] to-[#6D28D9] text-white rounded-full font-bold text-base hover:shadow-lg hover:shadow-[#4C1D95]/40 transition-all hover:-translate-y-1"
              >
                Postularme ahora
              </a>
