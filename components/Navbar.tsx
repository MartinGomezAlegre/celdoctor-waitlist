...
import InteractiveDemo from "./InteractiveDemo"; // Asegurate que la ruta sea correcta
        ...
        <div className="max-w-7xl mx-auto px-6 w-full h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
             <div className="hidden md:block">
                {/* Aquí usamos el componente InteractiveDemo o un botón simple que lleve a la sección */}
                <InteractiveDemo />
             </div>
